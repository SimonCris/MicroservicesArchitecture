...
/**Classe che viene utilizzata per configurare tutti i dati relativi alla chiamata
 * al server di google per l'autenticazione, nel rispetto del protocollo OpenIdConnect */
@Configuration
@EnableOAuth2Client
