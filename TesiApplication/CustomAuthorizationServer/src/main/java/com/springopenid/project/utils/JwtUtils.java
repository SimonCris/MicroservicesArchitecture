package com.springopenid.project.utils;
...
public class JwtUtils {
     ...
     */
    public String generateJwt(String subject, Date date/**, String name, String scope*/) throws java.io.UnsupportedEncodingException{
     ...
     * @throws java.io.UnsupportedEncodingException
     */
    public String jwt2MapRoleInfoJwt(String jwt) throws java.io.UnsupportedEncodingException, ExpiredJwtException, SubjectFieldNotFoundException {
        ...
        if(userData.get("subject") == null){
            throw new SubjectFieldNotFoundException("Subject field is null");
        }
