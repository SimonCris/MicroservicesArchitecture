...
<head>
    ...
    <title>Kitchen Products Page</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/goToKitchenProductsPage">Kitchen Products</a></li>
            </ul>
...
<div class="container">
    <h2 class = "productInfo">Kitchen Products</h2>
    <hr class="style1">
    <div class="table-responsive productContainer">
        <table class="table ">
            ...
            <c:forEach items="${kitchenProductsList}" var="prod">
            <tr>
                <td><a href="/productPage/${prod.idkitchen_product}&kitchen">
                    <img class="group list-group-image img-responsive"
                         src="../images/allProducts/${prod.kitchen_product_image}"
                         alt="${prod.kitchen_product_image}" style="height: 40%; weight: 70%;"/> </a>
                </td>
                <td class = "productInfo"><strong>${prod.kitchen_product_name}</strong></td>
                <td class = "productInfo"><strong>${prod.kitchen_product_brand}</strong></td>
                <td class = "productInfo"><strong>${prod.kitchen_product_price}</strong></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
